...
public class Programme_3_MarkSheet {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter Mark of Subject English \t:\t");
    ...
    public  static  void printTheMarkSheet(String name, int rollNum, int mathMarks, int scientMarks, int englishMarks, double total, double percentage, String result, String grade){
        ...
        System.out.println("| Science  : " + scientMarks +" |");
